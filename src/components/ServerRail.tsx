...
export function ServerRail({
  ...
  return (
    <nav className="flex w-[72px] shrink-0 flex-col items-center gap-1.5 overflow-y-auto overflow-x-hidden overscroll-y-contain border-r border-border-soft bg-card-3 py-3">
      <RailIcon
        href="/bandos"
